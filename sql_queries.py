...
songplay_table_insert = ("""INSERT INTO songplay(start_time, user_id, level, song_id, artist_id, session_id, location, user_agent)
                            ...
                            AND ev.artist = so.artist_name""") #joins the tables together where the song and artists to obtain unique values
...
user_table_insert = ("""INSERT INTO users(user_id, first_name, last_name, gender, level)
                        ...
                        AND page = 'NextSong'""") #only unique users are taken 
